...
class Muro:
    def __init__(self):
        ...
        self.mapa = [
            ...
            [99, 99,  99,  99,  99,  99,  99,  97,  96,  95,  94,  93,  92,  91,  90,  89,  99,  88,  87,  99,  99,  99,  99,  99,  99,  99,  99],
            [99, 99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99],
            ...
            [99,99, 99, 99, 99,  5, 0,  5,  99, 99, 99, 99, 99, 99, 99, 99, 99, 99,  5,  0,  5,  99, 99, 99, 99, 99, 99],  # Fila 12
