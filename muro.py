...
class Muro:
    def __init__(self):
        ...
        self.mapa = [
            ...
            [2, 2,  2,  2,  2,  14, 0,  6,  0,  15, 19, 19, 16, 16, 19, 19, 17, 99,  6,  0,  13, 2,  2,  2,  2,  2,  2],  # Fila 9
            [99,99, 99, 99, 99, 99, 0,  0,  0,  21, 99, 99, 99, 99, 99, 99, 22, 99,  0,  0,  99, 99, 99, 99, 99, 99, 99],  # Fila 10
            [2, 2,  2,  2,  2,  12, 0,  4,  0,  18, 23, 23, 23, 23, 23, 23, 20, 99,  4,  0,  11, 2,  2,  2,  2,  2,  2],  # Fila 11
            [99,99, 99, 99, 99,  5, 0,  5,  0,  0,  0,  0,  0,  0,  0,  0,  ,  99,  5,  0,  5,  99, 99, 99, 99, 99, 99],  # Fila 12
    ...
    def colision(self, x, y):
        ...
        for px, py in puntos_a_verificar:
            ...
            if 0 <= fila < len(self.mapa) and 0 <= columna < len(self.mapa[0]):
                ...
                if self.mapa[fila][columna] not in [0,99]:
                    return True
    ...
    def draw(self):
        ...
        for fila in range(len(self.mapa)):
            for columna in range(len(self.mapa[0])):
                ...
                if tipo_muro not in [0,99]:  # Si no es un espacio vacío
