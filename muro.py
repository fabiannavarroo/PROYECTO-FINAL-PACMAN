...
class Muro:
    def __init__(self):
        ...
        self.mapa = [
            ...
            [99, 99,  99,  99,  99,  99,  99,  70,  99,  99,  99,  99,  99,  99,  99,  99,  0,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99],
            [99, 99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99,  99],
            ...
            [99,99, 99, 99, 99, 99, 0, 99,  99, 21, 99, 71, 99, 99, 99, 99, 22, 99, 99,  0,  99, 99, 99, 99, 99, 99, 99],  # Fila 10
