    ...
    def mover_fantasma_rojo(self, fantasma):
        ...
        if fantasma.asustado:
            ...
            if direccion == PACMAN_ARRIBA:
                objetivo_x, objetivo_y = pacman_x, pacman_y - self.fantasma.celdas_para_emboscada * 16 # 4 celdas arriba
            elif direccion == PACMAN_ABAJO:
                objetivo_x, objetivo_y = pacman_x, pacman_y + self.fantasma.celdas_para_emboscada * 16  #
            elif direccion == PACMAN_IZQUIERDA:
                objetivo_x, objetivo_y = pacman_x - self.fantasma.celdas_para_emboscada * 16, pacman_y  # 4 celdas a la izquierda
            elif direccion == PACMAN_DERECHA:
                objetivo_x, objetivo_y = pacman_x + self.fantasma.celdas_para_emboscada * 16, pacman_y  # 4 celdas a la derecha
            else:
