...
class Tablero:
    ...
    def update(self):
        if self.pacman.vidas > 0:  # Mientras Pac-Man tenga vidas
    ...
    def movimiento_emboscada(self, fantasma, objetivo):
        if fantasma.siguiente_celda is None or (fantasma.x == fantasma.siguiente_celda[0] and fantasma.y == fantasma.siguiente_celda[1]):
            ...
            if ruta and len(ruta) > 1:
                ...
                # Si no hay ruta hacia la emboscada, intentar seguir a Pac-Man
    ...
    def buscar_ruta_simple(self, inicio, objetivo):
        # Se limita el número máximo de pasos en BFS para evitar congelamientos.
        max_pasos = 500  # Ajustar según sea necesario, un valor razonable para mapas no muy grandes.
        ...
        while cola:
            ...
            # Si excede el número máximo de pasos, abandonar la búsqueda
            if pasos > max_pasos:
                return None
