...
MAPA_2 = [
    # Fila 1
    (0, 16, 11),      # Esquina superior izquierda
    (16, 16, 2),     # Borde horizontal
    (32, 16, 2),     # Borde horizontal
    (48, 16, 2),     # Borde horizontal
    (64, 16, 2),     # Borde horizontal
    (80, 16, 7),     # Cruce en T hacia abajo
    (96, 16, 2),     # Borde horizontal
    (112, 16, 2),     # Borde horizontal
    (128, 16, 2),     # Borde horizontal
    (144, 16, 2),     # Borde horizontal
    (160, 16, 2),     # Borde horizontal
    (176, 16, 2),     # Borde horizontal
    (192, 16, 2),     # Borde horizontal
    (208, 16, 2),     # Borde horizontal
    (224, 16, 2),     # Borde horizontal
    (240, 16, 2),     # Borde horizontal
    (256, 16, 2),     # Borde horizontal
    (272, 16, 2),     # Borde horizontal
    (288, 16, 2),     # Borde horizontal
    (304, 16, 2),     # Borde horizontal
    (320, 16, 2),     # Borde horizontal
    (336, 16, 2),     # Borde horizontal
    (352, 16, 2),     # Borde horizontal
    (368, 16, 2),     # Borde horizontal
    (384, 16, 12),    # Esquina superior derecha

    # Fila 2
    (0, 32, 5),      # Borde vertical
    (384, 32, 5),    # Borde vertical

    # Fila 3
    (0, 48, 5),      # Borde vertical
    (96, 48, 7),     # Cruce en T hacia abajo
    (192, 48, 7),    # Cruce en T hacia abajo
    (384, 48, 5),    # Borde vertical

    # Fila 4
    (0, 64, 5),      # Borde vertical
    (48, 64, 11),    # Esquina superior izquierda
    (64, 64, 2),     # Borde horizontal
    (80, 64, 12),    # Esquina superior derecha
    (192, 64, 11),   # Esquina superior izquierda
    (208, 64, 2),    # Borde horizontal
    (224, 64, 12),   # Esquina superior derecha
    (384, 64, 5),    # Borde vertical

    # Fila 5
    (0, 80, 5),      # Borde vertical
    (48, 80, 5),     # Borde vertical
    (192, 80, 5),    # Borde vertical
    (336, 80, 5),    # Borde vertical
    (384, 80, 5),    # Borde vertical
    ...
    (192, 96, 6),    # Esquina inferior vertical
    (336, 96, 1),    # Esquina izquierda horizontal
    (352, 96, 2),    # Borde horizontal
    (368, 96, 14),   # Esquina inferior derecha

    # Fila 7
    (0, 112, 5),     # Borde vertical
    (192, 112, 5),   # Borde vertical
    (384, 112, 5),   # Borde vertical
    ...
    (48, 128, 2),    # Borde horizontal
    (64, 128, 12),   # Esquina superior derecha
    (192, 128, 1),   # Esquina izquierda horizontal
    (208, 128, 2),   # Borde horizontal
    (224, 128, 2),   # Borde horizontal
    (240, 128, 2),   # Borde horizontal
    (256, 128, 3),   # Esquina derecha horizontal
    (384, 128, 5),   # Borde vertical

    # Fila 9
    (0, 144, 5),     # Borde vertical
    (192, 144, 7),   # Cruce en T hacia abajo
    (384, 144, 5),   # Borde vertical
    ...
    (32, 160, 2),    # Borde horizontal
    (48, 160, 2),    # Borde horizontal
    (64, 160, 14),   # Esquina inferior derecha
    (192, 160, 11),  # Esquina superior izquierda
    (208, 160, 2),   # Borde horizontal
    (224, 160, 2),   # Borde horizontal
    (240, 160, 2),   # Borde horizontal
    (256, 160, 12),  # Esquina superior derecha
    (384, 160, 14),  # Esquina inferior derecha

    # Fila 11
    (0, 176, 5),     # Borde vertical
    (192, 176, 5),   # Borde vertical
    (384, 176, 5),   # Borde vertical
    ...
    (192, 192, 6),   # Esquina inferior vertical
    (384, 192, 12),  # Esquina superior derecha

    # Fila 13
    (0, 208, 5),     # Borde vertical
    (384, 208, 5),   # Borde vertical
    ...
    (48, 224, 2),    # Borde horizontal
    (64, 224, 2),    # Borde horizontal
    (192, 224, 7),   # Cruce en T hacia abajo
    (320, 224, 2),   # Borde horizontal
    (336, 224, 2),   # Borde horizontal
    (352, 224, 2),   # Borde horizontal
    (368, 224, 2),   # Borde horizontal
    (384, 224, 14),  # Esquina inferior derecha

    # Fila 15
    (0, 240, 5),     # Borde vertical
    (192, 240, 5),   # Borde vertical
    (384, 240, 5),   # Borde vertical
    ...
    (352, 256, 2),   # Borde horizontal
    (368, 256, 2),   # Borde horizontal
    (384, 256, 12),  # Esquina superior derecha
    ...
    (48, 288, 2),    # Borde horizontal
    (64, 288, 2),    # Borde horizontal
    (192, 288, 1),   # Esquina izquierda horizontal
    (320, 288, 2),   # Borde horizontal
    (336, 288, 2),   # Borde horizontal
    (352, 288, 2),   # Borde horizontal
    (368, 288, 2),   # Borde horizontal
    (384, 288, 14),  # Esquina inferior derecha

    # Fila 19
    (0, 304, 5),     # Borde vertical
    (192, 304, 5),   # Borde vertical
    (384, 304, 5),   # Borde vertical
    ...
    (48, 320, 2),    # Borde horizontal
    (64, 320, 2),    # Borde horizontal
    (192, 320, 7),   # Cruce en T hacia abajo
    (320, 320, 2),   # Borde horizontal
    (336, 320, 2),   # Borde horizontal
    (352, 320, 2),   # Borde horizontal
    (368, 320, 2),   # Borde horizontal
    (384, 320, 12),  # Esquina superior derecha
    ...
    (48, 352, 2),    # Borde horizontal
    (64, 352, 2),    # Borde horizontal
    (192, 352, 8),   # Cruce en T hacia arriba
    (320, 352, 2),   # Borde horizontal
    (336, 352, 2),   # Borde horizontal
    (352, 352, 2),   # Borde horizontal
    (368, 352, 2),   # Borde horizontal
    (384, 352, 14),  # Esquina inferior derecha

    # Fila 23
    (0, 368, 5),     # Borde vertical
    (192, 368, 5),   # Borde vertical
    (384, 368, 5),   # Borde vertical
