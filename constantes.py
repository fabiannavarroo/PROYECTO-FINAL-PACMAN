...
#BLOQUES NIVEL 2
SPRITE_BLOQUE_1_1 = (0,0,1,16,16) # Esquina izquierda horizontal
SPRITE_BLOQUE_2_1 = (8,0,1,16,16) # Borde horizontal
...
SPRITE_BLOQUE_7_1 = (0,16,1,16,16) # Cruce en T hacia abajo
SPRITE_BLOQUE_8_1 = (16,16,1,16,16) # Cruce en T hacia arriba
SPRITE_BLOQUE_9_1 = (32,16,1,16,16) # Cruce en T hacia derecha
SPRITE_BLOQUE_10_1 = (32,32,1,16,16) # Cruce en T hacia izquierda
SPRITE_BLOQUE_11_1 = (0,32,1,16,16) # Borde esquina superior izquieda
SPRITE_BLOQUE_12_1 = (16,32,1,16,16) # Borde esquina superior derecha
SPRITE_BLOQUE_13_1 = (0,48,1,16,16) #  Borde esquina inferior izquieda
SPRITE_BLOQUE_14_1 = (16,48,1,16,16) # Borde esquina inferior derecha
SPRITE_BLOQUE_15_1 = (8,72,1,16,16) # Esquina izquierda superior trampa fantasmas
SPRITE_BLOQUE_16_1 = (24,72,1,16,16) # Puerta salida de fantasmas
SPRITE_BLOQUE_17_1 = (40,72,1,16,16) # Esquina derecha superior trampa fantasmas
SPRITE_BLOQUE_18_1 = (8,88,1,16,16) # Esquina izquierda inferior trampa fantasmas
SPRITE_BLOQUE_19_1 = (32,56,1,16,16) # Borde superior trampa fantasma
SPRITE_BLOQUE_20_1 = (40,88,1,16,16) # Esquina derecha inferior trampa fantasmas
SPRITE_BLOQUE_21_1 = (8,80,1,16,16) # Borde derecha trampa fantasmas
SPRITE_BLOQUE_22_1 = (40,80,1,16,16) # Borde izquierda trampa fantasmas
SPRITE_BLOQUE_23_1 = (24,88,1,16,16) # Borde inferior trampa fantasma
