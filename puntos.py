...
class Puntos:
    def __init__(self, sprite, pacman, fantasmas, bloque):
        ...
        self.zonas_prohibidas = [(0,0,384,16), (0,192,80,224),(304,192,384,224),(32,64,64,96),(96,64,160,96), (224,64,288,96),(320,64,352,96), (0,160,80, 256)] # Zonas prohibidas para generar puntos
