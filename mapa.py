...
class Mapa:
    def __init__(self):
        ...
        self.mapa = [
            ...
            [7,0,18,22,22,27,0,18,22,22,22,20,0,13,14,0,18,22,22,22,20,0,32,22,22,20,0,8],  # Fila 22
            [7,0,19,23,27,14,0,19,23,23,23,21,0,10,12,0,19,23,23,23,21,0,13,32,23,21,0,8],  # Fila 23
            [],  # Fila 24
            [],  # Fila 25
            [],  # Fila 26
            [],  # Fila 27
