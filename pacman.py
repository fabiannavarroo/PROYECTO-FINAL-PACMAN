...
class Pacman:
    ...
    def mover(self):
        # Lógica de movimiento del Pacman
        ...
        if self.direccion_pendiente:
            # Verifica si la dirección pendiente es válida
        ...
        # Mover Pacman en la dirección actual
    ...
    def colision_fantasmas(self, fantasmas):
        ...
        if self.en_muerte:
            return  # Si está en animación de muerte, no manejar colisiones
        ...
        for fantasma in fantasmas:
            ...
            if pacman_x == fantasma_x and pacman_y == fantasma_y:
                if fantasma.asustado:
                    fantasma.volver_a_trampa()  # Si está asustado, ir a la trampa
                else:
                    self.perder_vida()  # De lo contrario, Pacman pierde una vida

    def perder_vida(self):
        # Lógica de pérdida de vida
        self.vidas -= 1
        self.en_muerte = True
    ...
    def animar_muerte(self, fantasmas):
        ...
        if pyxel.frame_count % 5 == 0:
            if self.animacion_frame < len(frames):
                ...
                self.en_muerte = False  # Animación terminada
                if self.vidas > 0:
                    for fantasma in fantasmas:
                        fantasma.volver_a_posicion_inicial()

    def draw(self, fantasmas):
        # Dibuja el Pacman o ejecuta la animación de muerte
        if self.en_muerte:
