from constantes import PACMAN, PACMAN_ARRIBA, PACMAN_ABAJO, PACMAN_IZQUIERDA, PACMAN_DERECHA,PORTALES, TEXTO_MUERTE, REFRESH
import pyxel
...
class Pacman:
    ...
    def draw(self):
        ...
        if pyxel.frame_count // REFRESH % 3 == 0:
