...
class Tablero:
    ...
    def draw(self):
        if self.estado_juego == "menu":
            ...
            pyxel.blt(180, 250, 0, 88, 160, 56, 8, colkey=0)  # P: Jugar
            pyxel.blt(180, 280, 0, 88, 168, 150, 8, colkey=0)  # N: Vision reducida
            pyxel.blt(180, 300, 0, 88, 176, 100, 8, colkey=0)  # N: Vision reducida
