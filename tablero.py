...
class Tablero:
    ...
    def draw(self):
        if self.estado_juego == "menu":
            ...
            pyxel.blt(240, 80, 0, 88, 160, 56, 8, colkey=0)  # P: Jugar
            pyxel.blt(280, 96, 0, 88, 168, 56, 8, colkey=0)  # N: Vision reducida
            pyxel.blt(320, 96, 0, 88, 176, 56, 8, colkey=0)  # N: Vision reducida
