...
class Tablero:
    ...
    def update(self):
        if self.estado_juego == "menu":
            ...
            self.modo_vision_reducida_update()
    ...
    def draw(self):
        if self.estado_juego == "menu":
            ...
            pyxel.blt(120, 250, 0, 88, 160, 56, 8, colkey=0)  # P: Jugar
            pyxel.blt(120, 280, 0, 88, 168, 150, 8, colkey=0)  # N: Vision reducida
            pyxel.blt(120, 300, 0, 88, 176, 100, 8, colkey=0)  # N: Vision reducida
