...
class Tablero:
    ...
    def colision_fantasmas(self, x, y):
        ...
        if self.fantasma.puerta_salida[0] <= x < self.fantasma.puerta_salida[0] + self.bloque.celda_tamaño and \
        self.fantasma.puerta_salida[1] <= y < self.fantasma.puerta_salida[1] + self.bloque.celda_tamaño:
            return False
