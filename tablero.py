...
class Tablero:
    def __init__(self):
        ...
        self.fantasmas = [
            FantasmaRojo(160, 200, self.muro),  # Coordenadas iniciales en la trampa
            FantasmaRosa(176, 200, self.muro),
            FantasmaAzul(192, 200, self.muro),
            FantasmaNaranja(208, 200, self.muro)
        ]
