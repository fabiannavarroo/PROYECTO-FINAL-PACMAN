...
class Tablero:
    def __init__(self):
        ...
        self.fantasmas = [
            FantasmaRojo(160, 175, self.muro),  # Coordenadas iniciales en la trampa
            FantasmaRosa(176, 175, self.muro),
            FantasmaAzul(192, 175, self.muro),
            FantasmaNaranja(208, 175, self.muro)
        ]
